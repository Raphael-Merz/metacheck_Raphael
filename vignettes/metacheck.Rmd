...
You will need to get your own API key from your preferred provider (e.g. <https://console.groq.com/keys>). To avoid having to type it out, add it to the .Renviron file in the following format (you can use `usethis::edit_r_environ()` to access the .Renviron file).
...
"0956797615588467", "0956797615588467"), answer = structure(c("{\"apriori\": true, \"test\": null, \"sample\": null, \"alpha\": null, \"power\": null, \"es\": null, \"es_metric\": null, \"notes\": \"A priori power analysis reported, but specific parameters (test, sample size, alpha, power level, effect size, effect size metric) are not provided in the sentence.\"}", 
"{\"apriori\": true, \"test\": null, \"sample\": 7, \"alpha\": null, \"power\": 0.95, \"es\": null, \"es_metric\": null, \"notes\": \"A priori power analysis is indicated with sample size and power, but test type, alpha, and effect size are not specified in the sentence.\"}", 
"{\"apriori\": false}", "{\"apriori\": true, \"test\": null, \"sample\": 26, \"alpha\": 0.05, \"power\": 0.8, \"es\": null, \"es_metric\": null, \"notes\": \"A priori power analysis is reported with sample size, alpha, and power, but test type and effect size are not specified in the sentence.\"}", 
"{\"apriori\": true, \"test\": null, \"sample\": 18, \"alpha\": 0.05, \"power\": 0.8, \"es\": null, \"es_metric\": null, \"notes\": \"A priori power analysis is reported with sample size, alpha, and power, but the test type and effect size are not specified in the sentence.\"}", 
"{\"apriori\": false}", "{\"apriori\": true, \"test\": \"contrasts of fMRI activity\", \"sample\": 24, \"alpha\": 0.002, \"power\": 0.8, \"es\": null, \"es_metric\": null, \"notes\": \"A priori power analysis is reported with sample size, power, and alpha. The test is contrasts of fMRI activity, but the specific effect size/metric is not provided in the sentence.\"}", 
"{\"apriori\": true, \"test\": null, \"sample\": null, \"alpha\": null, \"power\": null, \"es\": null, \"es_metric\": null, \"notes\": \"A priori power analysis reported, but no specific parameters (test type, sample size, alpha, power, effect size, effect size metric) are provided in the sentence.\"}", 
"{\"apriori\": true, \"test\": null, \"sample\": 72, \"alpha\": 0.05, \"power\": 0.8, \"es\": null, \"es_metric\": null, \"notes\": \"A priori power analysis reported using effect size from previous study, with sample size, power, and alpha, but test type and specific effect size/metric are not given.\"}"
), class = "ellmer_output")), class = c("metacheck_llm", "data.frame"
), row.names = c(NA, -9L), llm = list(system_prompt = "Does this sentence report an a priori power analysis? If so, return the test, sample size, critical alpha criterion, power level, effect size and effect size metric plus any other relevant parameters, in JSON format like:\n{\n  \"apriori\": true, \n  \"test\": \"paired samples t-test\", \n  \"sample\": 20, \n  \"alpha\": 0.05, \n  \"power\": 0.8, \n  \"es\": 0.4, \n  \"es_metric\": \"cohen's D\"\n}\nIf not, return {\"apriori\": false}\nAnswer only in valid JSON format, starting with { and ending with }.", 
